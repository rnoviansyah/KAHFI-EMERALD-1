-- ==========================================================
-- KAHFI EMERALD 1 RT 008/006 - CLEAN DATABASE SCHEMA FOR SUPABASE
-- ==========================================================
...
-- 5. AKTIFKAN ROW LEVEL SECURITY (RLS) & KEBIJAKAN KEAMANAN TABEL
-- Mengaktifkan RLS di seluruh tabel agar kueri langsung dari DevTools/Console terlindungi
...
-- 6. POLICY SECURITY: HAPUS AKSES SELECT LANGSUNG KE TABEL USERS DARI DEVTOOLS
-- Akses login dilakukan secara 100% aman via RPC Function verify_user_login (SECURITY DEFINER)
...
-- (TIDAK ADA POLICY SELECT UNTUK USERS: Mencegah intip username/password dari DevTools Console)

-- 7. POLICY KEAMANAN UNTUK TABEL OPERASIONAL APLIKASI
DROP POLICY IF EXISTS "allow_all_aset" ON public."Aset";
CREATE POLICY "allow_all_aset" ON public."Aset" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_aspirasi" ON public."Aspirasi";
CREATE POLICY "allow_all_aspirasi" ON public."Aspirasi" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_iuran" ON public."Iuran";
CREATE POLICY "allow_all_iuran" ON public."Iuran" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_kelahiran" ON public."Kelahiran";
CREATE POLICY "allow_all_kelahiran" ON public."Kelahiran" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_kematian" ON public."Kematian";
CREATE POLICY "allow_all_kematian" ON public."Kematian" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_keuangan" ON public."Keuangan";
CREATE POLICY "allow_all_keuangan" ON public."Keuangan" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_peminjaman" ON public."Peminjaman";
CREATE POLICY "allow_all_peminjaman" ON public."Peminjaman" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_pengaduan" ON public."Pengaduan";
CREATE POLICY "allow_all_pengaduan" ON public."Pengaduan" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_pengaturan" ON public."Pengaturan";
CREATE POLICY "allow_all_pengaturan" ON public."Pengaturan" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_pindahkeluar" ON public."PindahKeluar";
CREATE POLICY "allow_all_pindahkeluar" ON public."PindahKeluar" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_pindahmasuk" ON public."PindahMasuk";
CREATE POLICY "allow_all_pindahmasuk" ON public."PindahMasuk" FOR ALL USING (true) WITH CHECK (true);
...
DROP POLICY IF EXISTS "allow_all_sumbangan" ON public."Sumbangan";
CREATE POLICY "allow_all_sumbangan" ON public."Sumbangan" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_suratpengantar" ON public."SuratPengantar";
CREATE POLICY "allow_all_suratpengantar" ON public."SuratPengantar" FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "allow_all_warga" ON public."Warga";
CREATE POLICY "allow_all_warga" ON public."Warga" FOR ALL USING (true) WITH CHECK (true);
